---
title: Command injection in the es-hangul GitHub Actions workflow
date: 2024-10-17T18:00:00+12:00
type: disclosure
summary: An unsanitised workflow input interpolated straight into a shell step, allowing arbitrary commands to run in the workflow.
tags: [github-actions, command-injection, ci-cd]
cover: "run: yarn blc **${{ github.event.inputs.url }}** --ro"
image: ./injection-output.png
image_alt: act output showing the injected commands running
advisory:
  project: es-hangul
  component: broken-link-checker.yml
  status: Reported with fix PR
slug: github-actions-command-injection-hangul
---
...
```
![Can You See The Vulnerability? 👀](./spot-the-bug.png)
### The Problem
...
![The Injected Commands Executed Succesfully](./injection-output.png)
### Root Cause
