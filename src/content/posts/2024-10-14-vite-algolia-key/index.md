---
title: Admin-scoped Algolia API key exposed in Vite
date: 2024-10-14T18:00:00+12:00
type: disclosure
summary: An Algolia key with full create, read, update and delete rights was sitting in the Vite docs config and the page source.
tags: [secrets, apis, appsec]
cover: 'acl: [ "addObject", **"deleteIndex"**, "editSettings" ]'
advisory:
  project: vitejs/vite
  component: .vitepress/config.ts
  status: Reported · resolved
slug: algolia-api-key-misconfiguration-in-vite
---
...
![GitHub Advisory](./github-advisory.png)
...
![Data Injected Into An Existing Tag](./modify-settings.png)
...
![Confirming The Data Has Been Injected](./verify-settings.png)
