...
date: 2024-09-17T18:00:00+12:00
type: research
summary: The write-up of my OWASP NZ Day 2022 talk, covering the GraphQL issues we kept finding on pentests and how to lock them down.
tags: [graphql, apis, appsec]
cover: "query { **__schema** { types { name } } }"
slug: fantastic-graphql-bugs-and-where-to-find-them
---
...
![GraphQL Burger Analogy](https://s3.amazonaws.com/kinlane-productions2/graphql/DgsXLk_X4AEKiJJ.jpg)
...
![GraphQL vs REST](./graphql-vs-rest.png)
...
![mutation dot gif](https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExbHBxdDczY2pwOWh0YzE1YjMwdWw4M3A4eTRmbjZxd2ExendscGYxZiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/l2Jeg1lGgEYY0l3l6/giphy.webp)
...
![GraphQL Mutations](./mutation.png)
...
![Introspection query in the GraphQL explorer](./introspection-clippy.png)
...
![A Simple Schema](./simple-schema.png)

But it really shines with complex schemas as seen below:

![A Complex Schema](./complex-schema.png)
## Denial of Service (DoS)
...
![Example of a recursive query](./recursive-query.png)

By crafting increasingly complex queries, we can place additional load on the backend system, as seen in the images below:

![A Standard Query](./standard-query-load.png)

![A Recursive Query](./recursive-query-load.png)
...
<div class="myvideo">
   <video  style="display:block; width:100%; height:auto;" autoplay controls loop="loop">
       <source src="/media/graphql-idor.mp4" type="video/mp4" />
   </video>
</div>
...
<div class="myvideo">
   <video  style="display:block; width:100%; height:auto;" autoplay controls loop="loop">
       <source src="/media/graphql-injection.mp4" type="video/mp4" />
   </video>
</div>
